...
$INSTALLMENT_ACQUIRER=$arrpayment[1];
$TENOR=$arrpayment[2];
$PROMOID=$arrpayment[3];
...
<body onload="document.formRedirect.submit()">
	...
	<section class="default-width">
		...
		<form action="<?php echo $URL_REDIRECT;?>" method="POST" id="formRedirect" name="formRedirect">
			<input name="MALLID" value="<?php echo $_POST['MALLID']; ?>" type="hidden"> 
			<input name="PAYMENTCHANNEL" value="<?php echo $_POST['PAYMENTCHANNEL']; ?>" type="hidden"> 
			<input name="CHAINMERCHANT" value="<?php echo $_POST['CHAINMERCHANT']; ?>" type="hidden"> 
			...
			<input name="WORDS" value="<?php echo $_POST['WORDS']; ?>" type="hidden"> 
			...
			<input name="INSTALLMENT_ACQUIRER" value="<?php echo $INSTALLMENT_ACQUIRER; ?>" type="hidden"> 
			<input name="PROMOID" value="<?php echo $PROMOID; ?>" type="hidden"> 
			<input name="TENOR" value="<?php echo $TENOR; ?>" type="hidden">
			<input name="PAYMENTTYPE" value="OFFUSINSTALLMENT" type="hidden">
